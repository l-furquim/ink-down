    ...
    <div className="flex w-full h-full flex-col">
      <div className="flex p-8 w-full items-center">
        ...
        <span className="flex space-x-8 pl-8">
          <Link href="/download" className="text-zinc-400 hover:text-indigo-600 transition-all">
            Download
          </Link>
          <Link href="/about" className="text-zinc-400 hover:text-indigo-600 transition-all">
            Sobre
          </Link>
        </span>
        <Link href="/account" className="text-zinc-400 hover:text-indigo-600 transition-all pt-3 ml-auto pr-4">
          Conta
        </Link>
      </div>
      <div className="w-full h-full p-8 flex pt-32">
        <div className="w-[50%] flex flex-col pl-5 space-y-10">
          ...
          <p className="text-zinc-400 w-[70%] pb-20 text-xl">
            De forma gratuíta, escolha os arquivos
            que desjea incluir na núvem e os que não
            deseja
          </p>
          <Button className="bg-indigo-600 hover:bg-indigo-800 text-zinc-200 h-12 font-bold w-48" size={"lg"}>
            Começar
          </Button>
        </div>
        <div className="w-[50%]">
      ...
      <div className="w-full h-full flex pt-30 flex-col pl-8">
        ...
        <p className="text-zinc-400 text-xl w-[50%] pt-10">
          Crie seus próprios temas, compartilha suas notas
          e colabore para uma comunidade cíclica
        </p>
        <Link href={"/community"} className="pt-10 text-indigo-600 border-b-[1px] w-fit border-indigo-600">
          Ver mais
        </Link>
        <div className="w-full flex items-center text-zinc-400 justify-center space-x-6 pt-20">
          <div className="fkex flex-col w-72 h-48 space-y-5 hover:bg-zinc-300 p-2 rounded-md hover:cursor-pointer transition-all">
            ...
            <p>
              Escolha as notas que deseja compartilhar,
              e receba feedback com base nelas
            </p>
          </div>
          <div className="fkex flex-col w-72 h-48 space-y-5 hover:bg-zinc-300 p-2 rounded-md hover:cursor-pointer transition-all">
            <div className="flex items-center gap-2">
            ...
            <p>
              Explore os temas da comunidade e ecolha
              o que mais faz sua cara. Não encontrou nenhum?
              crie o seu próprio no editor de temas e publique
              para a comunidade.
            </p>
          </div>
          <div className="fkex flex-col w-72 h-48 space-y-5 hover:bg-zinc-300 p-2 rounded-md hover:cursor-pointer transition-all">
            ...
            <p>
              Graças ao formato das notas
              nossa aplicação é capaz de converter
      ...
      <div className="w-full h-full pb-30 items-center space-y-8 justify-center flex flex-col pl-5 pt-20">
        ...
        <div className="w-full h-72 flex justify-center items-center space-x-10">
          <div className="bg-zinc-300 border-[1px] border-muted-foreground w-72 group hover:cursor-pointer h-48 flex-col flex space-y-4 p-3 rounded-md text-zinc-800">
            ...
            <p>
              Entre em um servidor de pessoas que partilham
              seus estudos com a ink down
            </p>
          </div>
          <div className="bg-zinc-300 border-[1px] border-muted-foreground w-72 group hover:cursor-pointer h-48 flex-col flex space-y-4 p-3 rounded-md text-zinc-800">
            <span className="flex space-x-3 items-center group-hover:text-indigo-600">
            ...
            <p>
              Documentação contando um pouco sobre como utilizar o ink down
            </p>
          </div>
          <div className="bg-zinc-300 border-[1px] border-muted-foreground w-72 group hover:cursor-pointer h-48 flex-col flex space-y-4 p-3 rounded-md text-zinc-800">
            <span className="flex space-x-3 items-center group-hover:text-indigo-600">
